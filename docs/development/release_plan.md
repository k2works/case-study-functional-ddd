...
| **Iter 3** | 1.2 (完了), 1.3 | 10 | 31 | 56 | ⚠️ 部分完了 (Phase 8 のみ) |
| **Iter 4** | 1.4, 3.1 | 11 | 42 | 45 | 📋 計画中 |
...
- **イテレーション 3** は Phase 8（API 改善）のみ完了。Phase 1-7（Dapper + FluentMigrator 基盤構築、Story 1.2-1.4）は未着手。詳細は [イテレーション 3 計画](iteration_plan-3.md) および [レトロスペクティブ 3](retrospective-3.md) を参照してください。
